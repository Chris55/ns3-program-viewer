 ...
 */
export const ns3PanelEnabledMap = new Map([
    [0, "A only"],
    [1, "B only"],
    [2, "A & B"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns3DualKeyboardStyleMap = new Map([
    [0, "Panel"],
    [1, "Organ"],
    [2, "Piano"],
    [3, "Synth"],
 ...
 */
export const ns3KbZoneMap = new Map([
 ...
 * @type {Map<number, string>}
 */
export const ns3SplitNoteMap = new Map([
    [0, "F2"],
    [1, "C3"],
    [2, "F3"],
    [3, "C4"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SplitWidthMap = new Map([
    [0, "1"],
    [1, "6"],
    [2, "12"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns3TransposeMap = new Map([
    [0, "-6 semi"],
    [1, "-5 semi"],
    [2, "-4 semi"],
    [3, "-3 semi"],
 ...
 * @type {Map<number, string>}
 */
export const ns3PianoTypeMap = new Map([
    [0, "Grand"],
    [1, "Upright"],
    [2, "Electric"],
    [3, "Clav"],
 ...
 * @type {Map<number, string[]>}
 */
export const ns3PianoTimbreMap = new Map([
 ...
 * @type {Map<number, string>}
 */
export const ns3PianoKbTouchMap = new Map([
    [0, "Normal"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns3PianoLayerDetuneMap = new Map([
    [0, "Off"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns3OrganTypeMap = new Map([
    [0, "B3"],
    [1, "Vox"],
    [2, "Farfisa"],
    [3, "Pipe1"],
 ...
 * @type {Map<number, string>}
 */
export const ns3OrganVibratoChorusModeShortNameMap = new Map([
    [0, "V1"],
    [1, "C1"],
    [2, "V2"],
    [3, "C2"],
 ...
 */
export const ns3OrganVoxVibratoModeMap = new Map([
    ["V1", "Less"],
    ["V2", "More"],
    ["V3", "Original"],
]);
 ...
 * @type {Map<string, string>}
 */
export const ns3OrganFarfisaVibratoModeMap = new Map([
    ["V1", "Light/Slow"],
    ["V2", "Light/Fast"],
    ["C2", "Heavy/Slow"],
    ["C3", "Heavy/Fast"],
 ...
 * @type {Map<number, string>}
 */
export const ns3EffectSourceMap = new Map([
    [0, "Organ"],
    [1, "Piano"],
    [2, "Synth"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthVoiceMap = new Map([
    [0, "Poly"],
    [1, "Legato"],
    [2, "Mono"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthUnisonMap = new Map([
    [0, "Off"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthVibratoMap = new Map([
    [0, "Off"],
    [1, "Delay 1"],
    [2, "Delay 2"],
    [3, "Delay 3"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOscillatorTypeMap = new Map([
    [0, "Classic"],
    [1, "Wave"],
    [2, "Formant"],
    [3, "Super"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOscillator1ClassicWaveTypeMap = new Map([
    [0, "Sine"],
    [1, "Triangle"],
    [2, "Saw"],
    [3, "Square"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOscillator1WaveWaveTypeMap = new Map([
    [0, "Wave 2nd Harm"],
    [1, "Wave 3rd Harm"],
    [2, "Wave 4th Harm"],
    [3, "Wave 5th Harm"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOscillator1FormantWaveTypeMap = new Map([
    [0, "Formant Wave Aaa"],
    [1, "Formant Wave Eee"],
    [2, "Formant Wave Iii"],
    [3, "Formant Wave Ooo"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOscillator1SuperWaveTypeMap = new Map([
    [0, "Super Wave Saw"],
    [1, "Super Wave Saw 2"],
    [2, "Super Wave Square"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthPitchShiftRangeMap = new Map([
    [0, "±1 semi"],
    [1, "±2 semi"],
    [2, "±3 semi"],
    [3, "±4 semi"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthLfoWaveMap = new Map([
    [0, "Triangle"],
    [1, "Saw"],
    [2, "Neg Saw"],
    [3, "Square"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthLfoRateMap = new Map([
    [0, "0.03 Hz"],
    [1, "0.03 Hz"],
    [2, "0.03 Hz"],
    [3, "0.04 Hz"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthLfoRateMasterClockDivisionMap = new Map([
    [0, "4/1"],
    [1, "4/1"],
    [2, "4/1"],
    [3, "4/1"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthEnvAttackMap = new Map([
    [0, "0.5 ms"],
    [1, "0.6 ms"],
    [2, "0.7 ms"],
    [3, "0.9 ms"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthEnvDecayOrReleaseMap = new Map([
    [0, "3.0 ms"],
    [1, "3.5 ms"],
    [2, "4.0 ms"],
    [3, "4.6 ms"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthAmpEnvelopeVelocityMap = new Map([
    [0, "Off"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOscillatorsTypeMap = new Map([
    [0, "None"],
    [1, "1 Pitch"],
    [2, "2 Shape"],
    [3, "3 Sync"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthFilterTypeMap = new Map([
    [0, "LP12"],
    [1, "LP24"],
    [2, "Mini Moog"],
    [3, "LP+HP"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthFilterKbTrackMap = new Map([
    [0, "Off"],
    [1, "1/3"],
    [2, "2/3"],
    [3, "1"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthFilterDriveMap = new Map([
    [0, "Off"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthFilterCutoffFrequencyMap = new Map([
    [0, "14 Hz"],
    [1, "15 Hz"],
    [2, "15 Hz"],
    [3, "16 Hz"],
 ...
 * @type {Map<number, string>}
 */
export const ns3ArpeggiatorRangeMap = new Map([
    [0, "1 Octave"],
    [1, "2 Octaves"],
    [2, "3 Octaves"],
    [3, "4 Octaves"],
 ...
 * @type {Map<number, string>}
 */
export const ns3ArpeggiatorPatternMap = new Map([
    [0, "Up"],
    [1, "Down"],
    [2, "Up/Down"],
    [3, "Random"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthArpMasterClockDivisionMap = new Map([
    [0, "1/2"],
    [1, "1/2"],
    [2, "1/2"],
    [3, "1/2"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthArpRateMap = new Map([
    [0, "16 bpm"],
    [1, "16 bpm"],
    [2, "18 bpm"],
    [3, "20 bpm"],
 ...
 * @type {Map<number, string>}
 */
export const ns3RotarySpeakerSpeedMap = new Map([
    [0, "Slow/Stop"],
    [1, "Fast"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns3Effect1TypeMap = new Map([
    [0, "Panning"],
    [1, "Tremolo"],
    [2, "Ring Mod"],
    [3, "Wah-Wah"],
 ...
 * @type {Map<number, string>}
 */
export const ns3Effect1MasterClockDivisionMap = new Map([
    [0, "4/1"],
    [1, "4/1"],
    [2, "4/1"],
    [3, "4/1"],
 ...
 * @type {Map<number, string>}
 */
export const ns3Effect2TypeMap = new Map([
    [0, "Phaser 1"],
    [1, "Phaser 2"],
    [2, "Flanger"],
    [3, "Vibe"],
 ...
 * @type {Map<number, string>}
 */
export const ns3ReverbTypeMap = new Map([
    [0, "Room 1"],
    [1, "Room 2"],
    [2, "Stage 1"],
    [3, "Stage 2"],
 ...
 * @type {Map<number, string>}
 */
export const ns3DelayFilterMap = new Map([
    [0, "Bypass"],
    [1, "LP"],
    [2, "HP"],
    [3, "BP"],
 ...
 */
export const ns3DelayTempoMap = new Map([
 ...
 * @type {Map<number, string>}
 */
export const ns3DelayTempoMasterClockDivisionMap = new Map([
    [0, "1/2"],
    [1, "1/2"],
    [2, "1/2"],
    [3, "1/2"],
 ...
 * @type {Map<number, string>}
 */
export const ns3AmpSimTypeMap = new Map([
    [0, "Off"],
    [1, "Twin"],
    [2, "JC"],
    [3, "Small"],
 ...
 * @type {Map<number, string>}
 */
export const ns3AmpSimEqMidFilterFreqMap = new Map([
    [0, "200 Hz"],
    [1, "205 Hz"],
    [2, "210 Hz"],
    [3, "215 Hz"],
 ...
 * @type {Map<number, string>}
 */
export const ns3AmpSimEqdBMap = new Map([
    [0, "-15.0 dB"],
    [1, "-14.8 dB"],
    [2, "-14.5 dB"],
    [3, "-14.2 dB"],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthOsc0To4ControlMap = new Map([
    [0, "0.00"],
    [1, "0.03"],
    [2, "0.06"],
    [3, "0.10"],
 ...
 */
export const ns3SynthOscModulationMap = new Map([
    [0, -10.0],
    [1, -10.0],
    [2, -9.8],
    [3, -9.7],
 ...
 * @type {Map<number, string>}
 */
export const ns3SynthModulation120Map = new Map([
    [0, "10.0"],
    [1, "9.8"],
    [2, "9.7"],
    [3, "9.5"],
 ...
 * @type {Map<number, string>}
 */
export const ns3ProgramOutputMap = new Map([
    [0, "1-2"],
    [1, "3-4"],
    [2, "3"],
    [3, "4"],
 ...
 * @type {Map<number, string>}
 */
export const ns3ProgramOutputSourceMap = new Map([
    [0, "Off"],
    [1, "Organ"],
    [2, "Piano"],
    [3, "Synth"],
 ...
 * @type {Map<number, string>}
 */
export const ns3ExternControlMap = new Map([
    [0, "Midi CC"],
    [1, "Program"],
    [2, "Volume"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns3ExternMidiVelocityCurveMap = new Map([
    [0, "Soft"],
    [1, "Mid"],
    [2, "Hard"],
]);
