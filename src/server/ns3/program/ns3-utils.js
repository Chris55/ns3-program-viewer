 ...
 */
export const ns3KnobDualValues = function (valueRange120) {
 ...
 */
export const ns3KbZone = (sectionEnabled, global, value) => {
    // section is not used
    if (!sectionEnabled) {
 ...
 */
export const ns3VolumeEx = (buffer, offset, ns3yFile) => {
 ...
 */
export const ns3ProgramLocation = (bankValue, locationValue) => {
 ...
 * @returns {{bank: number, name: string, location: number, value: number}}
 */
export const ns3SynthLocation = (bankValue, locationValue) => {
    return {
        bank: bankValue,
        location: locationValue,
 ...
 */
export const ns3SynthPreset = (buffer, offset, ns3yFile) => {
    let location = 0;
    if (!ns3yFile) {
...
/***
 * returns NS3 Octave Shift obj
 *
 * @param rawValue
 * @returns {{midi, isDefault: boolean, value: string}}
 */
export const ns3OctaveShift = (rawValue) => {
...
/***
 * returns NS3 Boolean obj
 *
 * @param rawValue
 * @param defaultValue
 * @returns {{midi: (number), isDefault: boolean, enabled}}
 */
export const ns3BooleanValue = (rawValue, defaultValue) => {
    return {
        midi: rawValue ? 127 : 0,
        enabled: rawValue,
