 ...
 */
export const ns3Morph7Bits = (uint32Value, midiFrom, labelCallBack, forceDisabled) => {
 ...
 * @returns {{afterTouch: {to: {midi: *, value: (*|string)}, enabled: *}, controlPedal: {to: {midi: *, value: (*|string)}, enabled: *}, wheel: {to: {midi: *, value: (*|string)}, enabled: *}}}
 */
export const ns3Morph14Bits = (buffer, offset, labelCallBack, forceDisabled) => {
    const rawMorphValue = [3];
    const result = [];
 ...
 */
export const ns3MorphSynthOscillatorModulation = (uint32Value, fromValueRange120, left) => {
    const rawMorphValue = [3];
    const result = [];
 ...
 */
export const ns3MorphOrganDrawbar = (uint32Value, midiFrom) => {
    const rawMorphValue = [3];
    const result = [];
