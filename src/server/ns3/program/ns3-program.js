 ...
 */
const loadNs3ProgramFile = (buffer, filename) => {
    ...
    const transpose = {
        ...
        value: transposeEnabled ? ns3TransposeMap.get(transposeValue) : "",
    ...
    const split = {
        ...
        low: {
            width: splitEnabled && splitLowEnabled ? ns3SplitWidthMap.get((offset33W & 0x1800) >>> 11) : "Off",
            note: splitEnabled && splitLowEnabled ? ns3SplitNoteMap.get(splitLowNote) : "--",
        },
        mid: {
            width: splitEnabled && splitMidEnabled ? ns3SplitWidthMap.get((offset33W & 0x0600) >>> 9) : "Off",
            note: splitEnabled && splitMidEnabled ? ns3SplitNoteMap.get(splitMidNote) : "--",
        },
        high: {
            width: splitEnabled && splitHighEnabled ? ns3SplitWidthMap.get((offset33W & 0x0180) >>> 7) : "Off",
            note: splitEnabled && splitHighEnabled ? ns3SplitNoteMap.get(splitHighNote) : "--",
        },
    };
    ...
    const dualKeyboard = {
         ...
         */
        style: {
            value: ns3DualKeyboardStyleMap.get(dualKeyboardStyle),
