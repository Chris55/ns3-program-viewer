 ...
 */
export const ns2TransposeMap = new Map([
    [0, "-6"],
    [1, "-5"],
    [2, "-4"],
    [3, "-3"],
 ...
 */
export const ns2KbZoneMap = new Map([
 ...
 * @type {Map<number, string>}
 */
export const ns2SplitNoteMap = new Map([
    [0, "F2"],
    [1, "C3"],
    [2, "F3"],
    [3, "C4"],
 ...
 * @type {Map<number, string>}
 */
export const ns2PianoTypeMap = new Map([
    [0, "Grand"],
    [1, "Upright"],
    [2, "E Piano 1"],
    [3, "E Piano 2"],
 ...
 * @type {Map<number, string>}
 */
export const ns2PianoSlotDetuneMap = new Map([
    [0, "Off"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns2PianoClavinetModelMap = new Map([
    [0, "A"],
    [1, "B"],
    [2, "C"],
    [3, "D"],
 ...
 * @type {Map<number, string>}
 */
export const ns2PianoClavinetEqMap = new Map([
    [0, "Off"],
    [1, "Soft"],
    [2, "Medium"],
    [3, "Soft+Medium"],
 ...
 * @type {Map<number, string>}
 */
export const ns2PianoClavinetEqHiMap = new Map([
    [0, "Off"],
    [1, "Treble"],
    [2, "Brilliant"],
    [3, "Treble+Brilliant"],
 ...
 * @type {Map<number, string>}
 */
export const ns2PianoDynamicsMap = new Map([
    [0, "0"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns2OrganTypeMap = new Map([
    [0, "B3"],
    [1, "Vox"],
    [2, "Farfisa"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2OrganB3VibratoModeMap = new Map([
    [0, "V1"],
    [1, "C1"],
    [2, "V2"],
    [3, "C2"],
 ...
 * @type {Map<number, string>}
 */
export const ns2OrganVoxVibratoModeMap = new Map([
    [0, "Less (V1)"],
    [1, "More (V2)"],
    [2, "Original (V3)"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2OrganFarfisaVibratoModeMap = new Map([
    [0, "Light/Slow (V1)"],
    [1, "Light/Fast (V2)"],
    [2, "Heavy/Slow (C2)"],
    [3, "Heavy/Fast (C3)"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthVoiceMap = new Map([
    [0, "Off"],
    [1, "Legato"],
    [2, "Mono"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthUnisonMap = new Map([
    [0, "Off"],
    [1, "1"],
    [2, "2"],
    [3, "3"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthVibratoMap = new Map([
    [0, "Off"],
    [1, "Delay 1"],
    [2, "Delay 2"],
    [3, "Delay 3"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthOscillatorTypeMap = new Map([
    [0, "TRI"],
    [1, "SAW"],
    [2, "SQR"],
    [3, "SAMPLE"],
 ...
 */
export const ns2SynthOscillatorTriStyleWaveFormsMap = new Map([
    [0, ["---", "Analog Tri"]],
 ...
 * @type {Map<number, [string, string]>}
 */
export const ns2SynthOscillatorSawStyleWaveFormsMap = new Map([
    [0, ["---", "Analog Saw"]],
 ...
 * @type {Map<number, [string, string]>}
 */
export const ns2SynthOscillatorPulseStyleWaveFormsMap = new Map([
    [0, ["---", "Analog Sqr"]],
 ...
 * @type {Map<number, [string, string]>}
 */
export const ns2SynthOscillatorFmStyleWaveFormsMap = new Map([
    [0, ["Sin", "1-OP (+FB)"]],
    [1, ["1 1", "2-OP 1:1"]],
    [2, ["2 1", "2-OP 2:1"]],
    [3, ["3 1", "2-OP 3:1"]],
 ...
 * @type {Map<number, [string, string]>}
 */
export const ns2SynthOscillatorWaveStyleWaveFormsMap = new Map([
    [0, ["1", "Organ1"]],
    [1, ["2", "Organ2"]],
    [2, ["3", "Organ3"]],
    [3, ["4", "Organ4"]],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthOscillatorShapeModMap = new Map([
    [0, "10.0"],
    [1, "9.8"],
    [2, "9.6"],
    [3, "9.5"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthFilterTypeMap = new Map([
    [0, "LP12"],
    [1, "LP24"],
    [2, "HP"],
    [3, "NOTCH"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthFilterFrequencyMap = new Map([
    [0, "20 Hz"],
    [1, "21 Hz"],
    [2, "22 Hz"],
    [3, "24 Hz"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthFilterFrequencyMod2Map = new Map([
    [0, "10.0"],
    [1, "9.8"],
    [2, "9.6"],
    [3, "9.5"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthLfoWaveMap = new Map([
    [0, "SQUARE"],
    [1, "SAW"],
    [2, "TRI"],
    [3, "S/H"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthLfoRateMap = new Map([
    [0, "0.03 Hz"],
    [1, "0.03 Hz"],
    [2, "0.03 Hz"],
    [3, "0.04 Hz"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthLfoRateMasterClockDivisionMap = new Map([
    [0, "4/1"],
    [1, "4/1T"],
    [2, "2/1"],
    [3, "2/1T"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthEnvAttackMap = new Map([
    [0, "0.5 ms"],
    [1, "0.6 ms"],
    [2, "0.7 ms"],
    [3, "0.9 ms"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthEnvDecayMap = new Map([
    [0, "3.0 ms"],
    [1, "3.5 ms"],
    [2, "4.0 ms"],
    [3, "4.6 ms"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthEnvReleaseMap = new Map([
    [0, "3.0 ms"],
    [1, "3.5 ms"],
    [2, "4.0 ms"],
    [3, "4.6 ms"],
 ...
 * @type {Map<number, string>}
 */
export const ns2ArpeggiatorRangeMap = new Map([
    [0, "1 Octave"],
    [1, "2 Octaves"],
    [2, "3 Octaves"],
    [3, "4 Octaves"],
 ...
 * @type {Map<number, string>}
 */
export const ns2ArpeggiatorPatternMap = new Map([
    [0, "UP"],
    [1, "DN"],
    [2, "UP/DN"],
    [3, "RANDOM"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthArpMasterClockDivisionMap = new Map([
    [0, "1/2"],
    [1, "1/2T"],
    [2, "1/4"],
    [3, "1/4T"],
 ...
 * @type {Map<number, string>}
 */
export const ns2SynthArpRateMap = new Map([
    [0, "80 BPM"],
    [1, "82 BPM"],
    [2, "84 BPM"],
    [3, "86 BPM"],
 ...
 * @type {Map<number, string>}
 */
export const ns2EffectSourceMap = new Map([
    [0, "Organ"],
    [1, "Piano"],
    [2, "Synth"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2RotarySpeakerSpeedMap = new Map([
    [0, "Slow/Stop"],
    [1, "Fast"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2ReverbTypeMap = new Map([
    [0, "Room 1"],
    [1, "Room 2"],
    [2, "Stage 1"],
    [3, "Stage 2"],
 ...
 * @type {Map<number, string>}
 */
export const ns2AmpSimTypeMap = new Map([
    [0, "Off"],
    [1, "Small"],
    [2, "JC"],
    [3, "Twin"],
 ...
 * @type {Map<number, string>}
 */
export const ns2AmpSimEqdBMap = new Map([
    [0, "-15.0 dB"],
    [1, "-14.8 dB"],
    [2, "-14.5 dB"],
    [3, "-14.3 dB"],
 ...
 * @type {Map<number, string>}
 */
export const ns2AmpSimEqMidFilterFreqMap = new Map([
    [0, "200 Hz"],
    [1, "205 Hz"],
    [2, "210 Hz"],
    [3, "215 Hz"],
 ...
 */
export const ns2DelayTempoMap = new Map([
    [0, [750, "750 ms 80 bpm"]],
    [1, [732, "732 ms 82 bpm"]],
    [2, [714, "714 ms 84 bpm"]],
    [3, [698, "698 ms 86 bpm"]],
 ...
 * @type {Map<number, string>}
 */
export const ns2DelayTempoMasterClockDivisionMap = new Map([
    [0, "1/2"],
    [1, "1/4D"],
    [2, "1/4T"],
    [3, "1/4S"],
 ...
 * @type {Map<number, string>}
 */
export const ns2Effect1TypeMap = new Map([
    [0, "Panning"],
    [1, "Tremolo"],
    [2, "Ring Mod"],
    [3, "Wah-Wah"],
 ...
 * @type {Map<number, string>}
 */
export const ns2Effect1MasterClockDivisionMap = new Map([
    [0, "4/1"],
    [1, "4/1T"],
    [2, "2/1"],
    [3, "2/1T"],
 ...
 * @type {Map<number, string>}
 */
export const ns2Effect2TypeMap = new Map([
    [0, "Phaser 1"],
    [1, "Phaser 2"],
    [2, "Flanger"],
    [3, "Vibe"],
 ...
 * @type {Map<number, string>}
 */
export const ns2ExternControlMap = new Map([
    [0, "Midi CC"],
    [1, "Program"],
    [2, "Volume"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2ExternMidiVelocityCurveMap = new Map([
    [0, "Soft"],
    [1, "Normal"],
    [2, "Hard"],
]);
 ...
 * @type {Map<number, string>}
 */
export const ns2ProgramOutputMap = new Map([
    [0, "1&2"],
    [1, "3&4"],
    [2, "3"],
    [3, "4"],
