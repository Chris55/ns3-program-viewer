 ...
 */
export const ns2Morph7Bits = (uint32Value, midiFrom, labelCallBack, forceDisabled) => {
 ...
 * @returns {{afterTouch: {to: {midi: *, value: (*|string)}, enabled: *}, controlPedal: {to: {midi: *, value: (*|string)}, enabled: *}, wheel: {to: {midi: *, value: (*|string)}, enabled: *}}}
 */
export const ns2Morph4Bits = (rawMorph, midiFrom, labelCallBack, forceDisabled) => {
    const rawMorphValue = [3];
    const result = [];
 ...
 */
export const ns2MorphOrganDrawbar = (morphData, midiFrom, morphOn5Bits) => {
    const rawMorphValue = [3];
    const result = [];
 ...
 * @returns {{afterTouch: {to: {midi: *, value: (*|string)}, enabled: *}, controlPedal: {to: {midi: *, value: (*|string)}, enabled: *}, wheel: {to: {midi: *, value: (*|string)}, enabled: *}}}
 */
export const ns2Morph12Bits = (buffer, offset, labelCallBack, forceDisabled) => {
    const rawMorphValue = [3];
    const result = [];
