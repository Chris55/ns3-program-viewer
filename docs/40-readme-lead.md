...
| `0x0004` | `ffffffff` | [(f) file format](#nla1-file-format)
| `0x0005` | `--------` | 0
| `0x0006` | `--------` | 0
| `0x0007` | `--------` | 0
...
| `0x000F` | `--------` | 0
| `0x0010` | `cccccccc` | [(c) program category](#nla1-program-category)
| `0x0011` | `--------` |
| `0x0012` | `--------` |
| `0x0013` | `--------` |
| `0x0014` | `iiiiiiii` | [(i) file version](#nla1-file-version) (16-bit)
| `0x0015` | `iiiiiiii` |
| `0x0016` | `--------` |
| `0x0017` | `--------` |
...
| `0x0083` | `--------` |
| `0x0084` | `--------` |
| `0x0085` | `------o-` | [(o) reverb on](#nla1-reverb-on)
| `0x0086` | `--------` |
| `0x0087` | `--------` |
| `0x0088` | `--------` |
| `0x0089` | `--------` |
