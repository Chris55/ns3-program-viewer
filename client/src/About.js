        ...
        <div className="mx-auto mt-3" style={{ width: "80vw" }}>
            <Card className="border-0">
                <Card.Body>
                    ...
                    <Card.Text>
                        <AppName /> is a free and handmade application developed by Nord User Forum members, more
                        details{" "}
                        <a
                        ...
                        . This is an online collaboration, and we put a huge amount of effort into this viewer to be
                        accurate, feel free to contact us if something is wrong.
                    </Card.Text>

                    <Card.Text>
                        To clarify <a href="https://www.nordkeyboards.com">Nord Keyboards / Clavia DMI AB</a> position
                    ...
                    <blockquote className="m-3 blockquote">
                        <footer className="blockquote-footer text-muted">
                            I talked to the guys here, and it is fine with us for you to proceed with this project - as
                            long as you accompany your published work with a disclaimer that Clavia in no way is
                            affiliated with it. We will not be able to provide any assistance with this, but good luck
                            nonetheless!
                            <br />
                            <br />
                            @Clavia Support.
                    ...
                    <ul>
                        <li>
                            <a href="https://www.linkedin.com/in/christian-florentz-b2530575/">Christian Florentz</a>{" "}
                            (@florence)
                        </li>
                        <li>
