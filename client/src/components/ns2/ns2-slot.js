        ...
        return (
            <div className={visible ? "ns3-panel" : "d-none"}>
                <div className="row no-gutters">
                    ...
                    <div className="col">
                        <div>
                            <Ns2SectionOrgan className="ns3-section" data={data.organ} effects={data.effects} />
                        </div>

                        <div>
                            <Ns2SectionPiano className="ns3-section" data={data.piano} effects={data.effects} />
                        </div>

                        <div>
                            <Ns2SectionSynth className="ns3-section" data={data.synth} effects={data.effects} />
                        </div>

                        <div>
                            <Ns2SectionExtern className="ns3-section" data={data.extern} />
                        </div>
                    </div>
                </div>
            </div>
