            ...
            <div className={data.panelA.enabled === false && data.panelB.enabled === false ? "d-none" : ""}>
                <div className="row no-gutters ns3-header justify-content-between">
                    <div className="col align-self-center">
                        <h3 className="ns3-header-name">{data.id.name} {data.name}</h3>
                    ...
                    <div className="col-3">
                        <div className="row no-gutters ">
                            ...
                            <div className={data.split.enabled ? "col ml-2" : "col d-none"}>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td ><span className="nord-split ">{data.split.low.width}</span></td>
                                            <td ><span className="nord-split ">{data.split.mid.width}</span></td>
                                            <td ><span className="nord-split ">{data.split.high.width}</span></td>
                                        </tr>
                                        <tr>
                                            <td><span className="nord-split ">{data.split.low.note}</span></td>
                                            <td><span className="nord-split ">{data.split.mid.note}</span></td>
                                            <td><span className="nord-split ">{data.split.high.note}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
