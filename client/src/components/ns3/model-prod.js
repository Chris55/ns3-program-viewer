            ...
            synth: {
                ...
                oscillators: {
                    ...
                    control: {
                        ...
                        label: "2.08",
                        morph: {
                            wheel: { enabled: false, to: { midi: 66, label: "none" } },
                            afterTouch: { enabled: false, to: { midi: 66, label: "none" } },
                            controlPedal: { enabled: false, to: { midi: 66, label: "none" } },
                        },
                    },
                    ...
                    modulations: {
                        lfoAmount: {
                            ...
                            label: "3.5",
                            morph: {
                                wheel: { enabled: false, to: { midi: 41, label: "none" } },
                                afterTouch: { enabled: false, to: { midi: 41, label: "none" } },
                                controlPedal: { enabled: false, to: { midi: 41, label: "none" } },
                            },
                        },
                        modEnvAmount: {
                            midi: 0,
