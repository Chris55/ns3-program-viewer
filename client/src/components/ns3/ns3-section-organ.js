                        ...
                        <div className={visible ? "row nord-on" : "row nord-off"}>
                            ...
                            <div className="col-auto align-self-lg-auto">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span
                                            className={organ.percussion.enabled ? "nord-option-on" : "nord-option-off"}
                                        >
                                        ...
                                        <span
                                            className={
                                                organ.percussion.volumeSoft ? "nord-option-on" : "nord-option-off"
                                            }
                                        >
                                        ...
                                        <span
                                            className={
                                                organ.percussion.decayFast ? "nord-option-on" : "nord-option-off"
                                            }
                                        >
