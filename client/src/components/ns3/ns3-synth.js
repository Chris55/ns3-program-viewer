                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <span className="nord-option-on">
                                        ...
                                        <small>Mod Env Amount {synth.oscillators.modulations.lfoAmount.label} </small>
                                    </span>
                                </div>
                            </div>
                        </div>

                        <Ns3Fx className="col-auto  d-flex align-items-stretch"
                               data={this.props.effects} source="Synth" />
                    </div>
                </div>
            </React.Fragment>
        );
