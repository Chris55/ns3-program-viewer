            ...
            <div className="mx-auto mt-3" style={{ width: "80vw" }}>
                ...
                <Card className="border-0">
                    <Card.Body>
                        ...
                        <Card.Text>
                            <AppName /> is also available as an offline and standalone application. In this version,
                            everything is running locally, nothing is send to a remote server. Installer are available
                            for MacOS, Windows, and Linux Distributions.
                        </Card.Text>
                    </Card.Body>
                </Card>
                ...
                <Media className="mt-5">
                    <img width={64} height={64} className="align-self-start mr-3" src={microsoftLogo} alt="logo" />
                    <Media.Body>
                ...
                <Media className="mt-5">
                    <img width={54} height={54} className="align-self-start ml-1 mr-4" src={linuxLogo} alt="logo" />
                    <Media.Body>
