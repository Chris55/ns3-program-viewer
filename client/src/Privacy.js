        ...
        <div className="mx-auto mt-3" style={{ width: "80vw" }}>
            <Card className="border-0">
                <Card.Body>
                    ...
                    <Card.Text>
                        Well, EU law requires you to use cookie banners if your website contains cookies that are not
                        required for it to work. Common examples of such cookies are those used by third-party
                        analytics, tracking, and advertising services. These services collect information about people’s
                        behavior across the web, store it in their databases, and can use it to serve personalized ads.
                    </Card.Text>
                    <Card.Text>
                        At <AppName />, we want to protect user privacy, and we find cookie banners quite irritating, so
                        we decided to look for a solution. After a brief search, we found one: just don’t use any
                        non-essential cookies. Pretty simple, really. 🤔
                    </Card.Text>
                    <Card.Text>
                        So, we have removed all non-essential cookies from <AppName /> , and visiting our website does
                        not send any information to third-party analytics services. (And of course <AppName /> still
                        does not use any cookies to display ads, or track you across other sites.)
                    </Card.Text>
                    {/*<Card.Text>*/}
