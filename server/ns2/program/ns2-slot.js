...
exports.ns2Slot = function (buffer, id, splitEnabled, versionOffset, dualKeyboard) {
...
//        organ: getOrgan(buffer, panelOffset, splitEnabled, dualKeyboard, id),
        piano: ns2Piano(buffer, panelOffset, splitEnabled, dualKeyboard, id),
